...
6. The System starts the auto-rotation of the banner carousel (e.g., every 4 seconds).
...
- At step 6, if the User swipes left or right on the banner carousel:
  ...
  3. The System restarts the auto-rotation timer after 4 seconds of inactivity.
...
- BR-001: Banners must auto-rotate every 4 seconds
...
- AC-HOME-001-02 — Carousel auto-advances every 4s (FR-HOME-001, BR-001)
- AC-HOME-001-03 — Manual swipe halts auto-rotation; resumes after 4s idle (FR-HOME-001)
