# ADF Cinema — Component Roadmap

**Platform:** Flutter | **Design System:** Material Design 3 (Material You)
**Theme:** Dark Cinematic | **Updated:** 2026-05-28

> Planned components to build. Once shipped, they get promoted into [docs/design-system/component-catalog.md](../docs/design-system/component-catalog.md) via the `/design-system discover` action.
> All Flutter widgets must use `Theme.of(context).colorScheme` and `Theme.of(context).textTheme` — never hardcode hex colors.
...
| `shipped` | Built — move row to component-catalog.md |
...
When a component ships:
1. Implement at the listed path under `lib/widgets/`
2. Run `/design-system discover` — script extracts the widget into `docs/design-system/component-catalog.md`
3. Remove row from this roadmap (or mark `shipped`)
4. Catalog entry uses the lightweight schema: `Component | Description | Status | Source`

---

## Token Sources

- **Base tokens:** [docs/design-system/tokens.json](../docs/design-system/tokens.json)
- **Dark theme (default):** [docs/design-system/themes/dark.json](../docs/design-system/themes/dark.json)
- **Light theme:** [docs/design-system/themes/light.json](../docs/design-system/themes/light.json)
- **Principles & guidelines:** [docs/design-system/design-principles.md](../docs/design-system/design-principles.md)
